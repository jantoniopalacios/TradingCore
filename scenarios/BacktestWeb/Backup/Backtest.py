...
# ----------------------------------------------------------------------
# Importación limpia y profesional (funciona siempre si project_root está en sys.path)
from scenarios.BacktestWeb.configuracion import asignar_parametros_a_system, inicializar_configuracion_usuario
